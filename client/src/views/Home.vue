      ...
      <div>
        ...
        <div class="loginreg">
          <form>
            <div class="form-group">
              <h3>Login</h3>
              <input type="text" @keyup="emailLoginValid" v-model="email" :id="emailLogin" class="form-control" placeholder="email">
            </div>
            <div class="form-group">
...
export default {
  ...
  methods: {
    ...
    emailLoginValid: function () {
      ...
      if (re.test(String(this.email).toLowerCase())) {
        this.emailLogin = 'emailLoginTrue'
        // this.logVal = true
      } else {
        this.emailLogin = 'emailNotVal'
        // this.logVal = false
      }
    },
    passLoginValid: function () {
      if (this.password.length >= 4) {
        this.passLogVal = 'passwordTrue'
      } else {
        this.passLogVal = 'passwordFalse'
      }
    },
    ...
    emailRegisValid: function () {
      ...
      if (re.test(String(this.emailReg).toLowerCase())) {
        this.emailRegVal = 'emailRegistrationTrue'
        // this.logVal = true
      } else {
        this.emailRegVal = 'emailRegistrationFalse'
        // this.logVal = false
      }
    },
    passRegisValid: function () {
      if (this.passwordReg.length >= 4) {
        this.passRegVal = 'passwordRegistrationTrue'
      } else {
        this.passRegVal = 'passwordRegistrationFalse'
      }
    },
  ...
  computed: {
    logVal: function () {
      if (this.emailLogin == 'emailLoginTrue' && this.passLogVal == 'passwordTrue') {
        return true
      } else {
        return false
      }
    ...
    RegVal: function () {
      if (this.emailRegVal == 'emailRegistrationTrue' && this.passRegVal == 'passwordRegistrationTrue') {
        return true
      } else {
        return false
      }
